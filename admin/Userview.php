                ...
                <div class="pcoded-wrapper">
                                ...
                                <div class="main-menu-content">
                                    <ul>
                                        <li class="more-details">
                                            <a href="../include/logout.inc.php"><i class="ti-layout-sidebar-left"></i>Logout</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <<div class="pcoded-content">
                        ...
                        if (isset($_POST['search'])) {
                            ...
                            $list1 = mysqli_query($con, "select * from reg  WHERE name LIKE '%$searchKey%' ");
                        ...
                        ?>
                                            ...
                                            <div class="page-body">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>
                                                            <td>Name : <?php echo $row_list['name'] ?></td>
                                                        </h5>
                                                        <br><br>
                                                        <h6>User ID : <?php echo $row_list['userid'] ?></h6>
                                                    </div>
                                                    <div class="card-block table-border-style">
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Mail ID : <?php echo $row_list['mail'] ?></th>
                                                                        <th>Mobile : <?php echo $row_list['phone'] ?></th>
                                                                        <th>Website url : <?php echo $row_list['website_url'] ?> </th>

                                                                    </tr>
                                                                </thead>
                                                                <tbody>
                                                                    <tr>
                                                                        <td> Street : <?php echo $row_list['street'] ?></th>
                                                                        <td> City : <?php echo $row_list['city'] ?></td>
                                                                        <td>State : <?php echo $row_list['state'] ?></td>
                                                                        <td>Zipcode : <?php echo $row_list['zipcode'] ?></td>
                                                                    </tr>
                                                                    <tr>
                                                                    <tr>
                                                                        <th>Discord ID <?php echo $row_list['discord'] ?></th>
                                                                        <td>Youtube ID <?php echo $row_list['youtube'] ?></td>
                                                                        <td>Twitch ID <?php echo $row_list['twitch'] ?></td>
                                                                        <td>Facebook ID <?php echo $row_list['facebook'] ?></td>
                                                                    </tr>
                                                                    </tr>
                                                                    <tr>
                                                                    <tr>
                                                                        <th>Valorant ID : <?php echo $row_list['valorant_id'] ?></th>
                                                                        <th>Counter ID : <?php echo $row_list['counter_id'] ?></th>
                                                                        <th>Fortnite ID : <?php echo $row_list['fortnite_id'] ?></th>
                                                                        <th>FIFA ID : <?php echo $row_list['fifa_id'] ?></th>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                                        </div>
                            ...
                            $searchKey = "";
                            $list1 = mysqli_query($con, "select  *  from reg ");
                            while ($row_list = mysqli_fetch_assoc($list1)) {
                            ?>
                                <div class="pcoded-inner-content">
                                    <!-- Main-body start -->
