                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <?php
                                                            $list1 = mysqli_query($con, "select *  from tour_reg ");
                                                            while ($row_list = mysqli_fetch_assoc($list1)) {
                                                                $tour_id = $row_list['tour_id'];
                                                            ?>
                                                                <tr>

                                                                    <td><?php echo $row_list['tour_id'] ?></td>
                                                                    <td><?php echo $row_list['tour_name'] ?></td>
                                                                    <td><?php echo $row_list['hosted_by'] ?></td>
                                                                    <td>
                                                                        ...
                                                                        if ($status == 'Upcoming') {
                                                                        ?>
                                                                            <a href="../include/updatelive.php?tour_id=<?php echo $tour_id; ?>"> <button class="btn waves-effect waves-light btn-primary btn-outline-primary "><i class="icofont icofont-user-alt-3"></i>Live</button></a>


                                                                        <?php
                                                                        } elseif ($status == 'Live') {
                                                                        ?>
                                                                            <a href="../include/update_over.php?tour_id=<?php echo $tour_id; ?>"> <button class="btn waves-effect waves-light btn-primary btn-outline-primary "><i class="icofont icofont-user-alt-3"></i>Over</button></a>
